...
class camera {
  ...
  private:
    ...
    void initialize() {
      ...
      // Calculate u,v,w unit basic vectors for camera coordinate frame
      w = unit_vector(lookfrom - lookat);
      u = unit_vector(cross(vup, w));
      v = cross(w, u);

      // Calculate vectors across horizontal and down vertical viewport edges
      auto viewport_u = viewport_width * u;   // Across horizontal edge
      auto viewport_v = viewport_height * -v; // Down vertical edge
    ...
    // Returns a random point in square surrounding a pixel at origin
